...
const whatsappMessage = encodeURIComponent('Hi i am interested in joining your Gym. and keen to know the details');
...
function Header() {
  return (
    <header className="header">
      ...
      <a href={whatsappUrl} className="btn btn-primary header-btn" target="_blank" rel="noopener noreferrer">
        JOIN NOW
      </a>
    </header>
  );
    ...
    <section className="hero" ref={heroRef} data-visible={isVisible}>
      ...
      <div className="hero-content container">
        ...
        <div className="hero-actions">
          <a href={whatsappUrl} className="btn btn-primary" target="_blank" rel="noopener noreferrer">JOIN NOW</a>
...
function WhatsAppButton() {
  const phoneNumber = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '9876543210';
